...
hotel2 = Experience.create(category: "Accommodation", name: "El refugio de Cristal", address: "Camino de Robledo, 54, 45159 Hontanar, Toledo, Spain", availability: true, price: 90, country: "Spain", city: "Toledo", description: "El Refugio de Cristal est à 50 km au sud ouest de Tolède. Plus précisément, il est implanté dans la partie nord du parc national de Cabañeros. Loin de l’agitation des villes, il est le lieu idéal pour faire une coupure et se ressourcer. L’hotel responsable se compose de 5 chambres, dont une accessible aux personnes à mobilité réduite, et 1 suite. Grâce à la faible pollution lumineuse aux alentours, c’est le spot parfait pour observer les étoiles.", booked: false, image_url: "https://www.ethik-hotels.com/wp-content/uploads/2020/05/Tolede-El-refugio-de-Cristal.jpg")
